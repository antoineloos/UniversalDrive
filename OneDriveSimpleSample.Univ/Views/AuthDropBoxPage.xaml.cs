...
namespace OneDriveSimpleSample.Views
{
    ...
    /// </summary>
    public sealed partial class AuthDropBoxPage : Page
    {
        private readonly DropBoxService.DropBoxService _service;

        public AuthDropBoxPage()
        {
            this.InitializeComponent();
            _service = DropBoxPage._service;
            Loaded += (s, e) =>
            {

                Web.Navigate(_service.DropBoxStartUrl);
            };
