...
namespace OneDriveSimpleSample
{
    ...
    public class OneDriveService
    {
        ...
        private const string RequestChildren = "/drive/items/{0}/children?expand=thumbnails(select=small,medium,large)";
        private const string RequestItem = "/drive/items/{0}";
        private const string RequestThumbnailItem = "/drive/items/{0}/0/medium/content";
