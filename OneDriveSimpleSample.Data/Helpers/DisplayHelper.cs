...
namespace OneDriveSimpleSample.Helpers
{
    public static class DisplayHelper
    {
            ...
            Action<string> showDialog)
        {
            ...
            foreach (var child in children)
            {
                ...
                if (child.Thumbnails != null && child.Thumbnails.Length > 0)
                {
                    Debug.WriteLine($"thumbnails : {child.Thumbnails[0].Large.Url}");
                    Debug.WriteLine($"thumbnails : {child.Thumbnails[0].Medium.Url}");
                    Debug.WriteLine($"thumbnails : {child.Thumbnails[0].Small.Url}");
                }
